...
def efficient_version(predicate: Predicate) -> EfficientStatement:
    match predicate.predicate_type:
        ...
        case PredicateType.LENGTH_EQUATION | PredicateType.ANGLE_EQUATION:
...
class EquationStatement(tuple[str, ...]):
    def __new__(cls, predicate_name: str, *args: str):
        return super().__new__(cls, (predicate_name, *args))


class EquationPredicate(tuple[str, ...]):
    def __new__(cls, predicate_name: str, *args: str):
        return super().__new__(cls, (predicate_name, *args))
